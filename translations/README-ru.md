...
Я создал это, как список тем для подготовки к интервью на инженера ПО, но он вырос в огромный список, который вы можете наблюдать сейчас. После того, как я прошел через этот план обучения [я получил работу в Amazon](https://startupnextdoor.com/)

Вам, возможно, не потребуется учиться также прилежно, как я. В любом случае, все, что вам нужно - здесь.

Я учился 8-12 часов в день на протяжении нескольких месяцов. Вот моя история: [Почему я учился full-time на протяжении 8 месяцев для интервью в Google](https://medium.freecodecamp.org/why-i-studied-full-time-for-8-months-for-a-google-interview-cc662ce9bb13)
...
Это мой многомесячный план изучения, чтобы вырасти из веб-разработчика (самоучки, без технической вышки) в инженера ПО для большой компании. 

![Программирование на доске - от HBO's Silicon Valley](https://d3j2pkmjtin6ou.cloudfront.net/coding-at-the-whiteboard-silicon-valley.png)

Этот план полезен тем **новым разработчикам софта** или тем, кто переходит из веб-разработчиков/рпзрпботчиков софта в инженеров (которым необходимо знание CS). Если у вас много лет опыта работы ожидайте более сложного интервью.

Если у вас много лет опыта работы веб-разработчиком, имейте ввиду, что большие компании (FAANG) отличают инженеров от разработчиков софта и они требуют знания CS. 

Если вы хотите быть операционным инженером, изучайте больше из опционального списка (общение, безопасность).
...
- [Что это?](#what-is-it)
- [Зачем это использовать?](#why-use-it)
- [Как это использовать?](#how-to-use-it)
- [Не думайте, что вы недостаточно умный](#dont-feel-you-arent-smart-enough)
- [О Video ресурсах](#about-video-resources)
- [Процесс интервью & общая подготовка](#interview-process--general-interview-prep)
- [Выберите один язык для интервью](#pick-one-language-for-the-interview)
- [Список книг](#book-list)
- [Прежде чем начать](#before-you-get-started)
- [Что вы здесь не увидите](#what-you-wont-see-covered)
- [Необходимое знание](#prerequisite-knowledge)
- [Ежедневный план](#the-daily-plan)
- [Сложность алгоритмов/ Big-O / Асимптоматический анализ](#algorithmic-complexity--big-o--asymptotic-analysis)
...
- [Больше знаний](#more-knowledge)
    - [Бинарный поиск](#binary-search)
    - [Побитовые операции](#bitwise-operations)
- [Деревья](#trees)
    - [Деревья - записки и предыстория](#trees---notes--background)
    - [Бинарное дерево поиска: BSTs](#binary-search-trees-bsts)
    - [Куча / Приоритетная очередь / Бинарные кучи](#heap--priority-queue--binary-heap)
    - сбалансированные деревья поиска (концепция в общем, без деталей)
    - обход дерева: preorder, inorder, postorder, BFS, DFS
- [Сортировки](#sorting)
    - selection (выборкой)
    - insertion (вставкой)
    - heapsort ()
    - quicksort (быстрый поиск)
    - merge sort (слиянием)
- [Графы](#graphs)
    - directed (направленные)
    - undirected (ненаправленный)
    - adjacency matrix (матрицы смежности)
    - adjacency list (листы смежности)
    - traversals: BFS, DFS (поиск в глубины, в ширину)
- [Больше знаний](#even-more-knowledge)
    - [Рекурсия](#recursion)
    - [Динамическое программирование](#dynamic-programming)
    - [ООП программирование](#object-oriented-programming)
    - [Паттерны](#design-patterns)
    - [Комбинаторика (n choose k) & Вероятность](#combinatorics-n-choose-k--probability)
    - [NP, NP-полные and алгоритмы аппроксимации](#np-np-complete-and-approximation-algorithms)
    - [Кэши](#caches)
    - [Процессы и треды](#processes-and-threads)
    - [Тестирование](#testing)
    - [Откладывание](#scheduling)
    - [Поиски строки & манипуляции](#string-searching--manipulations)
    - [Tries](#tries)
    - [Цифры с плавающей точкой](#floating-point-numbers)
    - [Юникод](#unicode)
    - [Порядок байтов](#endianness)
    - [Networking](#networking)
- [Дизайн систем, масштабируемость, обработка данных](#system-design-scalability-data-handling) (если у вас более 4 лет опыта)
- [Финальное интервью](#final-review)
- [Практика](#coding-question-practice)
- [Задачки](#coding-exerciseschallenges)
- [Перед интервью](#once-youre-closer-to-the-interview)
- [Ваше резюме](#your-resume)
- [О чем думать на интервью](#be-thinking-of-for-when-the-interview-comes)
- [Вопросы для интервьюеру](#have-questions-for-the-interviewer)
...
- [Дополнительное изучение](#additional-learning)
    - [Компиляторы](#compilers)
    - [Emacs and vi(m)](#emacs-and-vim)
    - [Unix терминал](#unix-command-line-tools)
    - [Теория](#information-theory-videos)
    ...
    - [Сбалансированные деревья](#balanced-search-trees)
        - AVL trees
        - Splay trees
        - Red/black trees
        - 2-3 search trees
...
- [Серия видео](#video-series)
- [Курсы CS](#computer-science-courses)
- [Бумаги](#papers)
